...
FcValueCanonicalize (const FcValue *v)
{
    ...
    {
    case FcTypeString:
	newValue.u.s = FcValueString(v);
    newValue.type = FcTypeString;
	break;
    case FcTypeCharSet:
	newValue.u.c = FcValueCharSet(v);
    newValue.type = FcTypeCharSet;
	break;
    case FcTypeLangSet:
	newValue.u.l = FcValueLangSet(v);
    newValue.type = FcTypeLangSet;
	break;
    case FcTypeRange:
	newValue.u.r = FcValueRange(v);
    newValue.type = FcTypeRange;
	break;
    default:
	newValue = *v;
	break;
...
FcPatternObjectFindElt (const FcPattern *p, FcObject object)
{
    ...
    return &((FcPatternElt*)((intptr_t)(p)+((p)->elts_offset)))[i];
}
